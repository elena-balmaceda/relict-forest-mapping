import pandas as pd
  ...
  #ANALISIS ESTADISTICA ZONAL RECALL PARA IR

# Cargar el archivo CSV con la estadística zonal
file_path_ir_surviejo = '/Users/elenabalmaceda/Library/CloudStorage/OneDrive-UniversidadCatólicadeChile/PUBLICACIÓN TESIS EB/QGIS/SUR VIEJO/Estadistica zonal/planillas/estadistica_zonal_ir_surviejo.csv'  # Reemplaza con la ruta de tu archivo
df = pd.read_csv(file_path_ir_surviejo)
