import pandas as pd
  ...
  #ANALISIS ESTADISTICA ZONAL SWIR BOSQUE ILUGA

# Cargar el archivo CSV con la estadística zonal
file_path_swir_iluga = '/Users/elenabalmaceda/Library/CloudStorage/OneDrive-UniversidadCatólicadeChile/PUBLICACIÓN TESIS EB/QGIS/ILUGA/Estadistica zonal/planillas/estadistica_zonal_swir_iluga.qmd.csv'
df = pd.read_csv(file_path_swir_iluga)
