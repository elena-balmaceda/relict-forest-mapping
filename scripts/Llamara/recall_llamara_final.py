import pandas as pd
  ...
  #ANALISIS ESTADISTICA ZONAL RECALL PARA TODO LLAMARA

# Cargar el archivo CSV con la estadística zonal
file_path_final_llamara = '/Users/elenabalmaceda/Library/CloudStorage/OneDrive-UniversidadCatólicadeChile/PUBLICACIÓN TESIS EB/QGIS/LLAMARA/Estadistica zonal/planillas/estadistica_zonal_final_llamara.csv'
df = pd.read_csv(file_path_final_llamara)
